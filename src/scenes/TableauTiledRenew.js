class TableauTiledRenew extends Tableau{
    ...
    preload() {
        ...
        this.load.image('texte_planete_1', 'assets/ecrans_narration/texte_planete_1_5.png');
        this.load.image('texte_planete_2', 'assets/ecrans_narration/texte_planete_2_4.png');
